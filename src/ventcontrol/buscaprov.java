 ...
 * @author Usuario
 */
public class buscaprov extends JDialog {
    ...
    public buscaprov(menu menuprincipal, boolean modal) {
    ...
    void cargarcod(String valor){
        ...
        if(valor.equals("")){
            ...
            sql="SELECT * FROM proveedor where codprov='"+valor+"' ORDER BY codprov";
            System.out.print("entra en el segundo");
        }                
        model = new DefaultTableModel (null, titulos);        
        try{
