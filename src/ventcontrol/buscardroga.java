 ...
 * @author Usuario
 */
public class buscardroga extends JDialog {
    DefaultTableModel model;
    DefaultTableModel model1;
    DefaultComboBoxModel modeloRol;
    Integer band=0;
    String codid, id_droga, nombre_droga;
    String stockactu;
    String codp, nomp, telep, rucp, direccionp, droga_nombre;
    public buscardroga(menu menuprincipal, boolean modal) {
    ...
    void cargar(String valor){
        ...
        if(valor.equals("")){
            sql="SELECT * FROM droga ORDER BY id_droga";
            System.out.print("entra en el simple");
        }else{
            sql="SELECT * FROM droga where UPPER(nombre) LIKE UPPER('%"+valor+"%') ORDER BY id_droga";
        ...
        try{
                ...
                while(rs.next()){
                    registros[0] = rs.getString("id_droga");
                ...
                model.fireTableDataChanged();                                
                        ...
                        JOptionPane.showMessageDialog(null, "ERROR AL CARGAR LAS DROGAS");
        } 
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 40, -1, -1));
...
//        m.show();
    ...
    private void tablaproveedorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaproveedorMouseClicked
        ...
        if(FilaSelec>=0)            
        {
            ...
            droga_nombre=tablaproveedor.getValueAt(FilaSelec, 1).toString();
            this.dispose();
    ...
    private void nuevamarcaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nuevamarcaActionPerformed
        ...
        mimenu = new menu(0);
        Integer band=1;
        cm = new cargardroga(mimenu, true, band, "");
        cm.setVisible(true);
        if(cm.id_droga!=null){
            this.codid=cm.id_droga;
            droga_nombre=cm.nombre_droga;
            this.dispose();
        }
