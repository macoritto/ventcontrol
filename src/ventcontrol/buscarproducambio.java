 ...
 * @author Usuario
 */
public class buscarproducambio extends JDialog {
    ...
    public buscarproducambio(menu menuprincipal, boolean modal) {
    ...
    void cargar(String valor, String marca, String tipo){
        ...
        try{
                ...
                while(rs.next()){
                    //if(rs.getString("unidad_medida").equals("Litro") || rs.getString("unidad_medida").equals("Metro")){                    
