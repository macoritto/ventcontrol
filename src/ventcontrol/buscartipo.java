 ...
 * @author Usuario
 */
public class buscartipo extends JDialog {
    ...
    public buscartipo(menu menuprincipal, boolean modal) {
        ...
        buscartxt.setDocument(new solomayusculas());
         this.setTitle("Tipos de Producto.");
        cargar("");
    ...
    private void initComponents() {
        ...
        getContentPane().add(buscartxt, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 30, 600, 40));
