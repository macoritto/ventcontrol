 ...
 * @author Usuario
 */
public class buscarvendedor extends JDialog {
    ...
    public buscarvendedor(menu menuprincipal, boolean modal) {
    ...
    void cargar(String valor){
        String [] titulos ={"Cod","Nombre","Ci","Telefono"};
        ...
        if(valor.equals("")){
            ...
            sql="SELECT * FROM vendedor where nombre LIKE '%"+valor+"%' ORDER BY id";
...
//        String [] titulos ={"Cod","Nombre","Ci","Direccion"};
//        String [] registros = new String[4];
//        String sql;
//        if(valor.equals("")){
//            sql="SELECT * FROM vendedor where id!='1' ORDER BY id";
//            System.out.print("entra en el simple");
//        }else{
