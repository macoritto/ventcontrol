 ...
 * @author Usuario
 */
public class buscarventas2 extends JDialog {
    ...
    Integer codcliente;
    public buscarventas2(menu menuprincipal, boolean modal, Integer cod) {
    ...
    buscarventas2(menu2 mimenu2, boolean b) {
    ...
    void cargar(String valor){
        ...
        String sql, sql1;
        System.out.print("     ESTE ES EL CODIGO DEL CLIENTE   ");
        System.out.print(codcliente);
        if(valor.equals("")){
            sql="SELECT * FROM venta c inner join cliente p on c.cliente_id=p.id where c.estado='Pendiente' and c.porc_ven>0 and c.cliente_id='"+codcliente+"' ORDER BY codventa";
            System.out.print("entra en el simple");
        }else{
            sql="SELECT * FROM venta c inner join cliente p on c.cliente_id=p.id where c.estado='Pendiente' and c.porc_ven>0 and UPPER(p.nombre) LIKE UPPER('%"+valor+"%') and cliente_id='"+codcliente+"' ORDER BY codventa";
...
//    }    
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 70, 610, 380));
        ...
        getContentPane().add(guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 460, 160, 60));
        ...
        guardar1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/iconsearch.png"))); // NOI18N
        guardar1.setText("Seleccionar");
        guardar1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                guardar1ActionPerformed(evt);
            }
        });
        getContentPane().add(guardar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 460, 160, 60));
