...
public class cambio extends JDialog {
    ...
    public cambio(menu menuprincipal, boolean modal, Integer usuario) {
...
//        }                
        ...
        try{
                ...
                while(rs.next()){
                    ...
                    String sql3="SELECT * FROM detcambio where cambio_codcambio='"+rs.getString("id")+"'";
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 80, 740, 380));
        ...
        iconproveedor.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/barcode.png"))); // NOI18N
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 440, -1, -1));
...
//        m.show();
            ...
            try{        
                int confirmar = JOptionPane.showConfirmDialog(null, "Desea Eliminar el Cambio?");
                    if(confirmar==JOptionPane.YES_OPTION){
                            String sql3="SELECT * FROM detcambio where cambio_codcambio='"+cod+"'";
                            ...
                            while(rsaux.next()){
                                ...
                                st5.executeUpdate();
                                String sql7 ="DELETE FROM detcambio where id='"+rsaux.getString("id")+"'";
                                PreparedStatement st7 = cn.prepareStatement(sql7);
                                st7.executeUpdate();
                            }
                            sql ="DELETE FROM cambio where id='"+cod+"'";                                    
                            //conectar cc = new conectar();
                            //Connection cn = cc.conexion(); 
    ...
    private void view1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_view1ActionPerformed
        ...
        caja = new cargarcambio(mimenu, true, usuarioactu, "");
