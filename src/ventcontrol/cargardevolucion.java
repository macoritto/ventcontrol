 ...
 * @author Usuario
 */
public class cargardevolucion extends JDialog {
    ...
    Integer usuarioactu;
    Integer detinv;
    public cargardevolucion(menu menuprincipal, boolean modal, Integer usuario) {
    ...
    cargardevolucion(menu2 mimenu2, boolean b) {
...
//        m.show();
    ...
    private void guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardarActionPerformed
                ...
                try{
                    ...
                    conectar cc = new conectar();
                    Connection cn = cc.conexion();                    
                    String sql ="INSERT INTO devolucion(id_devo, descripcion, fecha, usuario, total,hora) VALUES ('"+cod.getText()+"','"+descrip.getText()+"','"+fechain.getDate()+"','"+usuarioactu+"','"+aux1+"','"+dateFormat.format(date)+"')";                                                         
