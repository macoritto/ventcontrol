 ...
 * @author Usuario
 */
public class cargargastos extends JDialog {

    DefaultTableModel model;
    DefaultComboBoxModel modeloRol;
    Integer band=0;
    Integer sumar=0, sumav=0, sumai=0;
    Integer usuarioactu, totalretiros=0;
    public cargargastos(menu menuprincipal, boolean modal, Integer usuario) {
    ...
    cargargastos(menu2 mimenu2, boolean b) {
    ...
    private void autonumerar(){
     ...
     void cargar(String valor){
        ...
        String [] titulos ={"Cod","Fecha","Descripcion", "Monto","Usuario", "Caja"};
...
//        }                
    ...
    private void initComponents() {
        ...
        jLabel2.setText("   REGISTRAR GASTOS");
        ...
        guardar1.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                guardar1FocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                guardar1FocusLost(evt);
            }
        });
...
//        m.show();
    ...
    private void guardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_guardar1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(cargargastos.class.getName()).log(Level.SEVERE, null, ex);
        }
        monto5 = w.intValue();
        if(monto5>0){
...
//                    if(diferencia>=monto5){
                            try{                                  
                                        ...
                                        String sql ="INSERT INTO gastos (id, fecha, monto, descripcion, usuario, caja, idaux) VALUES ('" +cod.getText()+"','"+calendar.getDate()+"','" +monto4.toString()+"','" +descrip.getText()+ "','"+usuarioactu+"','1','-1')";                                                        
                                        ...
                                        if(st.executeUpdate()>0){
                                                cargar("");
                                                JOptionPane.showMessageDialog(null, "Se Registro el Gasto.");                               
                                        }                    
                                        //p.cargar(valor);                          
                                        st.close();                        
                                        this.dispose();
...
//                        }
    ...
    private void guardar1FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_guardar1FocusGained
        guardar1.setBackground(Color.red);
    }//GEN-LAST:event_guardar1FocusGained

    private void guardar1FocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_guardar1FocusLost
        guardar1.setBackground(new java.awt.Color(0,102,153));
    }//GEN-LAST:event_guardar1FocusLost
