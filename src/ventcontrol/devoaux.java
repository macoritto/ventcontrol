 ...
 * @author Usuario
 */
public class devoaux extends JDialog {
    ...
    public devoaux(menu menuprincipal, boolean modal, Integer idprodu) {
    ...
    void cargar(String valor){
        ...
        try{
                ...
                while(rs.next()){
                    ...
                    aux2=Double.parseDouble(rs.getString("venta"));
                    preciopro=Integer.parseInt(rs.getString("venta"));
...
//       delete.setEnabled(false);
    ...
    private void initComponents() {
        ...
        getContentPane().add(fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 810, 220));
