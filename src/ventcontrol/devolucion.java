...
public class devolucion extends JDialog {
    ...
    Integer band=0;
    Integer usuarioactu;
    public devolucion(menu menuprincipal, boolean modal, Integer usuario) {
        super(menuprincipal, modal);
        initComponents();        
        this.setLocation(300, 30);  
        int contador=0;
        this.setTitle("Devoluciones de Mercadería.");
        usuarioactu=usuario;
    ...
    devolucion(menu2 mimenu2, boolean b) {
...
void abrirproveedor(){
    ...
    private void initComponents() {
        ...
        jLabel6.setText("DEVOLUCIONES DE MERCADERÍA.");
...
//        m.show();
    ...
    private void nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nuevoActionPerformed
      ...
      mp = new cargardevolucion(mimenu, true, usuarioactu);
      mp.setVisible(true);
      if(mp.model!=null){
            ...
            try{        
                int confirmar = JOptionPane.showConfirmDialog(null, "Desea Eliminar el Inventario?");
                    if(confirmar==JOptionPane.YES_OPTION){
                            System.out.print("  ENTRA EN LA OPCION DE SI");
                            String sql1="SELECT * FROM detdevo where devolucion='"+cod+"'";
                            conectar cc = new conectar();
                            Connection cn = cc.conexion();
                            Statement staux = cn.createStatement();
                            ResultSet rsaux = staux.executeQuery(sql1);
                            while(rsaux.next()){
                                String sqlaux="SELECT * FROM producto where codprodu='"+rsaux.getString("producto")+"'";
                                ...
                                st2.executeUpdate();
                                String sql2 ="DELETE FROM detdevo where devolucion='"+rsaux.getString("id_det")+"'";
                                PreparedStatement st1 = cn.prepareStatement(sql2);
                                st1.executeUpdate();
                            }                                
                            String sql ="DELETE FROM devolucion where id_devo='"+cod+"'";                                                                 
    ...
    private void viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewActionPerformed
      ...
      mp = new verdevolucion(mimenu, true, usuarioactu, id);
      mp.setVisible(true);
      if(mp.model!=null){
//          tablacliente.setModel(mp.model);
//          tablacliente.getColumnModel().getColumn(0).setPreferredWidth(60);
