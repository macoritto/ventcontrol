 ...
 * @author Usuario
 */
public class drogas extends JDialog {
    ...
    public drogas(menu menuprincipal, boolean modal) {
...
//        }    
    ...
    private void nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nuevoActionPerformed
        ...
        mimenu = new menu(0);
        this.band=1;
        cm = new cargardroga(mimenu, true, this.band, "");
        cm.setVisible(true);         
    ...
    private void viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewActionPerformed
        ...
        mimenu = new menu(0);
        this.band=2;
        cp = new updatedroga(mimenu, true, this.band, codigo);        
        cp.setVisible(true);  
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if(FilaSelec>=0)
        {
            ...
            try{
                int confirmar = JOptionPane.showConfirmDialog(null, "Desea Eliminar la Droga?");
                if(confirmar==JOptionPane.YES_OPTION){
                    sql ="DELETE FROM droga where id_droga='"+cod+"'";
                    conectar cc = new conectar();
                    Connection cn = cc.conexion();
