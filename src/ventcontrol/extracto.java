 ...
 * @author Usuario
 */
public class extracto extends JDialog {

    DefaultTableModel model;
    DefaultComboBoxModel modeloRol;
    Integer band=0;
    String codid, montofactura, saldo, fcliente;
    public extracto(menu menuprincipal, boolean modal) {
    ...
    extracto(menu2 mimenu2, boolean b) {
    ...
    void cargar(String valor){
        ...
        try{
                ...
                while(rs.next()){                    
                    ...
                    sql1="SELECT * FROM venta v where v.cliente_id='"+rs.getString("id")+"' and v.estado='Pendiente' and v.porc_ven>0";
                    System.out.print(sql1);
                    Statement st1 = cn.createStatement();
                    ResultSet as = st1.executeQuery(sql1);
                    while(as.next()){
                        conta=conta+1;                       
                        monto=monto+Integer.parseInt(as.getString("porc_ven"));
                    }
                    if(conta>0){
                        registros[0] = rs.getString("id");
                        registros[1] = rs.getString("nombre")+" "+rs.getString("apellido");
                        registros[2] = formateador.format(conta);
                        registros[3] = formateador.format(monto);
                        contasaldo=contasaldo+monto;
...
//    }    
    ...
    private void initComponents() {
        ...
        getContentPane().add(deuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 520, 140, 30));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(255, 255, 255));
        jLabel1.setText("TOTAL DEUDA:");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(373, 524, 110, 20));

        fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/azul2.jpg"))); // NOI18N
        getContentPane().add(fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 650, 570));
