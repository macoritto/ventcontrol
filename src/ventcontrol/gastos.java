 ...
 * @author Usuario
 */
public class gastos extends JDialog {
    ...
    public gastos(menu menuprincipal, boolean modal, Integer usuario) {
...
//        }                
    ...
    private void initComponents() {
        ...
        getContentPane().add(iconproveedor, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 290, 150, 150));
...
//        m.show();
    ...
    private void viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewActionPerformed
        ...
        try {
            reti = new updategastos(mimenu, true, usuarioactu, codigo);
            reti.setVisible(true);
            if(reti.model!=null){
            tablacliente.setModel(reti.model);
...
//           } 
        if(FilaSelec>=0){
            ...
            try{        
                int confirmar = JOptionPane.showConfirmDialog(null, "Desea Eliminar el Gasto?");
                    if(confirmar==JOptionPane.YES_OPTION){
                            sql ="DELETE FROM gastos where id='"+cod+"'";                                    
                            //conectar cc = new conectar();
                            //Connection cn = cc.conexion(); 
                            ...
                            if(st.executeUpdate()>0){
                                JOptionPane.showMessageDialog(null, "Se eliminó correctamente el Gasto.");                      
                                st.close(); 
                            }  
    ...
    private void view1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_view1ActionPerformed
        ...
        menu mimenu;
        mimenu = new menu(usuarioactu);
        caja = new cargargastos(mimenu, true, usuarioactu);
        ...
        if(caja.model!=null){
            ...
            tablacliente.getColumnModel().getColumn(4).setPreferredWidth(60);
            tablacliente.getColumnModel().getColumn(5).setPreferredWidth(60);
            buscartxt.setText(formateador.format(caja.totalretiros));
            //deudaaux=cv.deuda;
