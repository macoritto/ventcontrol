 ...
 * @author Usuario
 */
public class listasaldo extends JDialog {
    ...
    public listasaldo(menu menuprincipal, boolean modal) {
        ...
        int contador=0;
         this.setTitle("Ingresos de efectivo a la caja.");
        cargar("");
    ...
    void cargar(String valor){
        ...
        try{
                ...
                while(rs.next()){
                    ...
                    //registros[2] = rs.getString("hora_");
                    registros[2] = rs.getString("coja_saldo");        
    ...
    private void initComponents() {
        ...
        getContentPane().add(search, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 20, 80, 50));
        ...
        jLabel3.setText("INGRESOS DE EFECTIVO A LA CAJA");
