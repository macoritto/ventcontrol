 ...
 * @author Usuario
 */
public class mportipo extends JDialog {

    DefaultTableModel model;
    DefaultComboBoxModel modeloRol;
    Integer band=0;
    public mportipo(menu menuprincipal, boolean modal) {
    ...
    mportipo(menu2 mimenu2, boolean b) {
    ...
    void cargarprodu(String valor){
        ...
        String sql, sql1;        
        sql="SELECT * FROM tipo where id='"+valor+"' ORDER BY id";
    ...
    void cargarventas(String valor){
        ...
        String sql, sql1;        
        sql="SELECT * FROM detventa d inner join producto p on d.producto_codprodu=p.codprodu inner join tipo t on p.tipo_id=t.id where t.id='"+cod.getText()+"' ORDER BY d.id";
        System.out.print("entra en el segundo");
        System.out.print(sql);
        ...
        try{
                ...
                cn.close();
                        ...
                        JOptionPane.showMessageDialog(null, "EN EL SQL DE TIPO INNER");
        }        
    }
void abrirproveedor(){
    buscartipo p;
...
void cargarprov(String valor){
    ...
    private void initComponents() {
        ...
        jLabel6.setText("VENTAS POR TIPO.");
