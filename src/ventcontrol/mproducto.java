 ...
 * @author Usuario
 */
public class mproducto extends JDialog {

    DefaultTableModel model;
    DefaultComboBoxModel modeloRol;
    Integer band=0;
    public mproducto(menu menuprincipal, boolean modal) {
    ...
    mproducto(menu2 mimenu2, boolean b) {
...
void cargarprov(String valor){
    ...
    private void initComponents() {
        ...
        jLabel6.setText("VENTAS POR PRODUCTO.");
