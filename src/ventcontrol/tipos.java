 ...
 * @author Usuario
 */
public class tipos extends JDialog {
    ...
    public tipos(menu menuprincipal, boolean modal) {
    ...
    void cargar(String valor){
        ...
        if(valor.equals("")){
            ...
            sql="SELECT * FROM tipo where UPPER(nombre) LIKE UPPER('%"+valor+"%') ORDER BY id";
...
//        }    
    ...
    private void nuevoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nuevoActionPerformed
        ...
        mimenu = new menu(0);
        this.band=1;
        cm = new cargartipo(mimenu, true, this.band, "");
        cm.setVisible(true);         
    ...
    private void viewActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_viewActionPerformed
        ...
        mimenu = new menu(0);
        this.band=2;
        cp = new updatetipo(mimenu, true, this.band, codigo);        
        cp.setVisible(true);  
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        if(FilaSelec>=0)
        {
            ...
            try{
                int confirmar = JOptionPane.showConfirmDialog(null, "Desea Eliminar la Tipo de Producto?");
                if(confirmar==JOptionPane.YES_OPTION){
                    sql ="DELETE FROM tipo where id='"+cod+"'";
                    conectar cc = new conectar();
                    Connection cn = cc.conexion();
