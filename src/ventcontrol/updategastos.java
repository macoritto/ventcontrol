 ...
 * @author Usuario
 */
public class updategastos extends JDialog {
    ...
    public updategastos(menu menuprincipal, boolean modal, Integer usuario, String codigo) throws ParseException {
    ...
    updategastos(menu2 mimenu2, boolean b) {
    ...
    private void autonumerar(){
     ...
     void cargar(String valor) throws ParseException{
        ...
        Date fecha= new Date();
        String sql;        
            sql="SELECT * FROM gastos where id='"+codretiro+"'";
    ...
    void cargargastos(String valor){
        DecimalFormat formateador = new DecimalFormat("###,###");
...
//                    if(diferencia>=monto5){
                            sql4 ="UPDATE gastos SET monto='"+montoretiro.toString()+"', descripcion='"+descrip.getText()+"'  where id='"+cod.getText()+"'";         
                            conectar cc = new conectar();
                            Connection cn = cc.conexion();
                            try{        
